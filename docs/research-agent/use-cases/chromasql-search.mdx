...
Query the SAP knowledge graph directly using ChromaSQL—without going through the Research Agent. This approach gives you precise control over search parameters and is ideal for bulk searches or when you know exactly what you're looking for.
