...
You may search the components in the attached system using the SAP Research Agent or by writing SQL-like queries (using ChromaSQL). More on ChromaSQL [here](use-cases/search-index.mdx).
